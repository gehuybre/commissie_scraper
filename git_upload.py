...
configures the remote 'origin' to point to https://github.com/gehuybre/commissie_scraper.git,
...
def main():
    ...
    if github_token:
        ...
        remote_url = f"https://{username}:{github_token}@github.com/{username}/commissie_scraper.git"
    else:
        remote_url = f"https://github.com/{username}/commissie_scraper.git"
